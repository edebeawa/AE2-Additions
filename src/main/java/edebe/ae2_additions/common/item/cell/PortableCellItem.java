...
public final class PortableCellItem extends AbstractPortableCell<IAEItemStack> {
    public PortableCellItem(final ComponentType componentType, final CellMaterialType materialType) {
